...
def parse_args():
    ...
    parser.add_argument(
        "--action_space", default="xy", type=str
    ...
    parser.add_argument("--early_stage", default=5000, type=int)

    # SMG
    parser.add_argument("--back_scale", default=0, type=float)
    parser.add_argument("--recon_scale", default=0, type=float)
    parser.add_argument("--mask_scale", default=0, type=float)
    parser.add_argument("--mask_percentage", default=0, type=float)
    parser.add_argument("--fore_scale", default=0, type=float)
    parser.add_argument("--action_scale", default=0, type=float)
    parser.add_argument("--grad_clip_norm", default=100, type=float)
    ...
    parser.add_argument("--consistency_scale", default=0.5, type=float)
